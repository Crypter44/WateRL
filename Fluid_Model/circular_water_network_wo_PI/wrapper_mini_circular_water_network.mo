...
model wrapper_mini_circular_water_network
  ...
  Modelica.Blocks.Sources.Step step2(height=1)
    annotation (Placement(transformation(extent={{-88,22},{-68,42}})));
  Modelica.Blocks.Sources.Step step3(height=1)
    annotation (Placement(transformation(extent={{-60,48},{-40,68}})));
  Modelica.Blocks.Sources.Step step4(height=1)
...
equation
  connect(step.y, mini_circular_water_network_wo_PI1.w_v_6)
    annotation (Line(points={{5,-22},{30.6,-22},{30.6,9.2}}, color={0,0,127}));
  connect(step1.y, mini_circular_water_network_wo_PI1.w_p_1) annotation (Line(
        points={{-37,10},{-16,10},{-16,19.8},{-6.8,19.8}}, color={0,0,127}));
  connect(step2.y, mini_circular_water_network_wo_PI1.w_v_2) annotation (Line(
        points={{-67,32},{-18,32},{-18,27.2},{-7,27.2}}, color={0,0,127}));
  connect(step3.y, mini_circular_water_network_wo_PI1.w_v_3) annotation (Line(
        points={{-39,58},{-16,58},{-16,39.6},{-7.4,39.6}}, color={0,0,127}));
  connect(step4.y, mini_circular_water_network_wo_PI1.w_p_4)
